...
namespace PIT.API.Controllers.common
{
 //   [Authorize]
    ...
    {
        private IStoreRoom _svr ;
        public StoreRoomController(IStoreRoom Service) { _svr = Service; }
        ...
        [HttpPost]
        public ResultModel Post([FromBody]StoreRoomModel obj)
        {
            return _svr.Insert(obj);
        }

        [HttpPut]
        public ResultModel Put([FromBody]StoreRoomModel obj)
        {
